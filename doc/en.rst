...
.. list-table::
    ...
    * - Unrealized biomass potential (Carbon sequestration) in **metric tons C/hectare**
      - Unrealized potential aboveground biomass, belowground biomass, and soil organic carbon combined density (megagrams carbon per hectare) under baseline climate. (see below). (`view in gee <https://code.earthengine.google.com/d5c24c1fd3b6dc7ca0153bea9d9ffb32>`__)
