...
It drew data for remaining spatial layers primarily from the following sources. For additional detail, see :ref:`appendix_c` (benefits), :ref:`appendix_e` (costs), and :ref:`seplan-appendix-f` (constraints).
